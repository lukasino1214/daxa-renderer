...
IBLRenderer IBLRenderer::load(daxa::Device& device, daxa::PipelineCompiler& pipeline_compiler, daxa::Format swapchain_format) {
    ...
    daxa::SamplerId BRDFLUT_sampler = device.create_sampler({
        ...
        .adress_mode_u = daxa::SamplerAddressMode::CLAMP_TO_EDGE,
        .adress_mode_v = daxa::SamplerAddressMode::CLAMP_TO_EDGE,
        .adress_mode_w = daxa::SamplerAddressMode::CLAMP_TO_EDGE,
        .min_lod = 0.0f,
        .max_lod = 1.0f,
    });
    ...
    daxa::ImageId env_map_image = device.create_image({
        .dimensions = 2,
    ...
    daxa::ImageId irradiance_cube_image = device.create_image({
        .dimensions = 2,
        .format = daxa::Format::R32G32B32A32_SFLOAT,
        .size = { 32, 32, 1 },
    ...
    daxa::ImageId prefiltered_cube_image = device.create_image({
        .dimensions = 2,
        .format = daxa::Format::R32G32B32A32_SFLOAT,
        .size = { 512, 512, 1 },
    ...
    daxa::RasterPipeline skybox_pipeline = pipeline_compiler.create_raster_pipeline({
    ...
    return IBLRenderer {
        ...
        .env_map_image = env_map_image,
        .env_map = {
            .image_view_id = env_map_image_view,
            .sampler_id = env_map_sampler
        },
        .irradiance_cube_image = irradiance_cube_image,
        .irradiance_cube = {
            .image_view_id = irradiance_cube_image_view,
            .sampler_id = irradiance_cube_sampler
        },
        .prefiltered_cube_image = prefiltered_cube_image,
        .prefiltered_cube = {
...
void IBLRenderer::destroy(daxa::Device& device) {
